...
async def status(ctx, *,game):	
    ...
    if ctx.message.author.id == '428298038612590612': 
            ...
            embed.add_field(name="賽Game:", value="Succesfully game name changed with: {}".format(game))
            await bot.say(embed=embed)
    else:
...
async def listenst(ctx, *,game):	
    ...
    if ctx.message.author.id == '428298038612590612': 
            ...
            embed = discord.Embed(color=0xb5ff29)
            embed.add_field(name="賽Music Status:", value="Succesfully music status name changed with: {}".format(game))
            await bot.say(embed=embed)
    else:
    	    await bot.say("```Only bot owner```")    	  
...
async def status1(ctx):
    ...
    if ctx.message.author.id == '428298038612590612':
                ...
                embed = discord.Embed(color=0xb5ff29)
                embed.add_field(name="賽Game:", value="Succesfully game name changed with: status1")
                await bot.say(embed=embed)
...
async def russianroulette(ctx, user1: discord.User=None, user2: discord.User=None, user3: discord.User=None, user4: discord.User=None, user5: discord.User=None, user6: discord.User=None, user7: discord.User=None):
	...
	if select == "{ctx.message.author}":
		...
		embed.add_field(name="Game Started", value=f"{ctx.message.author} shot and dead 馃敨", inline=True)
		await bot.say(embed=embed)		
	if select == "{user3)":		
		embed = discord.Embed(title="Russian Roulette", colour=(0x36393E))
		...
		embed = discord.Embed(title="Russian Roulette", colour=(0x36393E))
		users0 = ctx.message.author		
		embed.add_field(name="Game Started", value=f"{user3} shot and dead 馃敨", inline=True)
		await bot.say(embed=embed)		
	if select == "{user2)":		
		embed = discord.Embed(title="Russian Roulette", colour=(0x36393E))
		...
		embed = discord.Embed(title="Russian Roulette", colour=(0x36393E))
		users0 = ctx.message.author		
		embed.add_field(name="Game Started", value=f"{user2} shot and dead 馃敨", inline=True)
		await bot.say(embed=embed)
	if select == "{user1)":		
		embed = discord.Embed(title="Russian Roulette", colour=(0x36393E))
		embed.add_field(name="Game", value=f"{user3} Survived!", inline=True)
		...
		embed = discord.Embed(title="Russian Roulette", colour=(0x36393E))
		users0 = ctx.message.author		
		embed.add_field(name="Game Started", value=f"{user1} shot and dead 馃敨", inline=True)
		await bot.say(embed=embed)              
...
async def hack(ctx, hack: discord.User=None):	
   if hack is None:
     embed = discord.Embed(color=0xb5ff29)   	
     embed.add_field(name="賽LOL", value="You need hack yourself ? start with shut down phone/pc")
     await bot.say(embed=embed)
   else:
     embed = discord.Embed(color=0xb5ff29)
     ...
     resp = embed.add_field(name="賽Mail:", value="I'm searching mail...")
...
async def lock(ctx):
	if ctx.message.author.server_permissions.manage_channels:
            ...
            await bot.add_reaction(ctx.message, emoji="馃敀")            
	else:
...
async def unlock(ctx):
	if ctx.message.author.server_permissions.manage_channels:
            ...
            await bot.edit_channel_permissions(ctx.message.channel, role, overwrite)
            await bot.add_reaction(ctx.message, emoji="馃敁")
	else:
		await bot.say("You need MANAGE/CHANNEL permission.", delete_after = 2)	
...
async def rps(context):
        ...
        reactions = await bot.add_reaction(rps, '鉁�'),  await bot.add_reaction(rps, '馃枑'), await bot.add_reaction(rps, '鉁�')
        ...
        if str(reaction.reaction.emoji) == "鉁�":
                if bot_response == "鉁�":
                    await bot.edit_message(rps, "I choose 鉁� \n\n**Draw ! :joy:**")
                if bot_response == "鉁�":
                    await bot.edit_message(rps, "I choose 鉁� \n\n**You win ! :angry:**")
                if bot_response == "馃枑":
                    await bot.edit_message(rps, "I choose 馃枑 \n\n**You loose ! :astonished: **")

        if str(reaction.reaction.emoji) == "馃枑":
                if bot_response == "鉁�":
                    await bot.edit_message(rps, "I choose 鉁� \n\n**You loose ! :astonished: **")
                if bot_response == "馃枑":
                    await bot.edit_message(rps, "I choose 馃枑 \n\n**Draw ! :joy:**")
...
async def hug(ctx, user: discord.Member = None):
    ...
    if user is not None:
        ...
        embed = discord.Embed(title="{} You got hugged by {} ! So cute 馃枻".format(user.name, ctx.message.author.name), color=0xDEA6D5)
...
async def cigaret(ctx):
      a = await bot.say("馃毈馃敟")
      await bot.edit_message(a, new_content="馃毈馃挩")
      await asyncio.sleep(1.5)
      await bot.edit_message(a, new_content="馃毈馃挩馃挩馃挩")
      await asyncio.sleep(3)      
      await bot.edit_message(a, new_content="馃毈馃挩馃挩")
      await asyncio.sleep(5)      
      await bot.edit_message(a, new_content="馃毈馃挩")
      await asyncio.sleep(1.3)      
      await bot.edit_message(a, new_content="馃毈馃棏锔�")
     ...
     if ctx.message.author.server_permissions.manage_roles or is_owner:
         try:
            ...
            return
             ...
             poop = discord.Embed(title = "鉂� No Permission", description= "I don't have the `MANAGE_CHANNEL/MANAGE_ROLES` permission.", color = 0x000000)
...
async def work(ctx):
        ...
        if str(ctx.message.author.id) in coins:
            ...
            works = ["**:basketball: You go out and play professional basketball. ", "**馃捇 You go out and work as a sysadmin. ", "**<:bagofmoney:505431842929770496> You go out and work as a economist.", "**:soccer: You go out and work as a footballer ", "**:peanuts: You go out and work as a peanut dealer. "]
...
async def slot(ctx, amount: int):
        ...
        if (a == b == c):
            ...
            await bot.say(content=f"**SLOTS | <:777:504325063814676504>**\n\n{a1} : {b1} : {c1}\n\n{a} : {b} : {c} **芦**\n\n{a2} : {b2} : {c2}\n\n**{ctx.message.author.name}**, All matching, you won {amount} coins! 馃帀")
            ...
            await bot.say(content=f"**SLOTS | <:777:504325063814676504>**\n\n{a1} : {b1} : {c1}\n\n{a} : {b} : {c} **芦**\n\n{a2} : {b2} : {c2}\n\n**{ctx.message.author.name}**, 2 in a row, you won {amount//2} coins! 馃帀")
            coins[author_id]['coins'] += amount//2

        else:
            await bot.say(content=f"**SLOTS | <:777:504325063814676504>**\n\n{a1} : {b1} : {c1}\n\n{a} : {b} : {c} **芦**\n\n{a2} : {b2} : {c2}\n\n**{ctx.message.author.name}**, No match, you lost {amount} coins! 馃槩")
            coins[author_id]['coins'] -= amount
...
async def h(ctx):
         embed = discord.Embed(colour=discord.Colour.green())
         embed.add_field(name='Music Commands',value="Reaction: 馃帶", inline=True)          
         embed.add_field(name='Moderation Commands',value="Reaction: 馃攳", inline=True)
         embed.add_field(name='Fun Commands',value="Reaction: 馃嵐", inline=True)
         embed.add_field(name='Information & Other Commands',value="Reaction: 馃捑", inline=True)
         embed.add_field(name='Image Commands',value="Reaction: 馃帹", inline=True)
         ...
         reaction = await bot.add_reaction(message,'馃帶'), await bot.add_reaction(message,'馃攳'), await bot.add_reaction(message,'馃嵐'), await bot.add_reaction(message,'馃捑'), await bot.add_reaction(message,'馃帹')
         reaction = await bot.wait_for_reaction(message=message, user = ctx.message.author)
         if str(reaction.reaction.emoji) == "馃攳":
         	em = discord.Embed(color=0xea7938)
         	...
         	await bot.say(embed=em)
         	reaction = await bot.wait_for_reaction(message=message, user = ctx.message.author)
         elif str(reaction.reaction.emoji) == "馃嵐":		
                ...
                reaction = await bot.wait_for_reaction(message=message, user = ctx.message.author)                
         elif str(reaction.reaction.emoji) == "馃捑":
...
async def dice(numbers=None):
	if numbers is None:
		embed = discord.Embed(colour=discord.Colour.green()) 
		embed.add_field(name='Dice',value="馃幇 **Please chose number from 0-10**")
		await bot.say(embed=embed)
		return
	...
	if numbers is not None:		
	          numbers = ['1','2','3','4','0','5','6','7','8','9','10']
	          embed = discord.Embed(colour=discord.Colour.blue()) 
	          embed.add_field(name='Dice',value="馃幇 **You chose number: {}**".format(random.choice(numbers)))
	          await bot.say(embed=embed)
@bot.command()
async def rate(target: discord.Member):
           cards = ['-99999999999','10/10','0/9','0/8','0/7','0/6','0/5', '0/4','0/3','0/2','0/1']		
           embed = discord.Embed(colour=discord.Colour.green())                 
           embed.add_field(name='Rate',value=target.mention + " 馃 **I give it to him** **{}**".format(random.choice(cards)))
           await bot.say(embed=embed)	
...
async def rateidiot(ctx, target: discord.Member=None):
	if target is None:
              ...
              embed = discord.Embed(colour=discord.Colour.green()) 
              embed.add_field(name='Rate Idiot',value="馃幇 " + ctx.message.author.mention + " **is {}**".format(random.choice(cards)))
              await bot.say(embed=embed)
              return
	else:
              cards = ['%19 idiot','%32 idiot','%48 idiot','%76 idiot','%100 idiot xDD','%16 idiot','%0 idiot','%5 idiot','%68 idiot','%51 idiot','%66 idiot','%34 idiot','%41 idiot','%24 idiot']
              embed = discord.Embed(colour=discord.Colour.green()) 
              embed.add_field(name='Rate Idiot',value="馃幇 " + target.mention + " **is {}**".format(random.choice(cards)))
              await bot.say(embed=embed)
